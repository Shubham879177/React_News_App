...
export class News extends Component {
  ...
  async updateNews() {
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=1ec3d1cb866e4c38b45c33bb7b6eab8d&page=${this.state.page}&pageSize=${this.props.pageSize}`
